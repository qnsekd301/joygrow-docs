...
| JoyGrow 독립 관리자 | 학생, 포인트, 열매상점, 성경 인물, 믿음원정, 정책, 감사 로그 |
...
![열매상점 관리](../images/admin/store.png)

- 상품 가격과 재고, 외부 공개 가능한 이미지를 관리합니다. 상품 사진은 여러 장 등록할 수 있습니다. 업로드가 끝나고 저장되었는지 미리보기로 확인합니다.
...
![믿음원정 관리](../images/admin/faith-adventure.png)
