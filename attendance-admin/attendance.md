...
반별 출석에서는 학생 이름과 출결을 한 줄에서 처리합니다. 어묵과 재량도 함께 기록할 수 있습니다. 날짜와 반을 먼저 확인하세요.
...
| 진한 남색 요약 | 입력률과 출석·결석·미체크·사유 없음 숫자 |
| 검색과 상태 탭 | 학생 검색과 상태별 필터 |
...
5. 어묵은 **1–3** 또는 **4–6** 구간을 선택합니다.
6. 필요한 경우 운영 기준 안에서 **재량**을 기록합니다.
7. 남색 요약에서 **미체크 0명**과 **사유 없음 0명**을 확인합니다.
...
출석·어묵·재량은 JoyGrow 포인트와 EXP에 연결됩니다. 포인트를 맞추기 위해 출석 사실을 바꾸지 마세요. 실제 출석 기록을 원본으로 유지하세요.
