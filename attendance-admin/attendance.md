...
반별 출석에서는 학생 이름과 출결을 한 줄에서 처리합니다. 오목과 재량도 함께 기록할 수 있습니다. 날짜와 반을 먼저 확인하세요.
...
출석·오목·재량은 JoyGrow 포인트와 EXP에 연결됩니다. 포인트를 맞추기 위해 출석 사실을 바꾸지 마세요. 실제 출석 기록을 원본으로 유지하세요.
