...
4. 연락, 기도, 심방, 확인 등 다음 행동을 선택합니다.
5. 담당자와 예정일을 남깁니다.

## 이름을 통일하는 원칙

- `이철균 가정`, `이철균 선생님`, `이철균 집사님`은 기본 인물 이름 **이철균**을 기준으로 연결합니다.
...
상담, 건강, 가정 형편은 목양에 필요한 최소 범위만 적습니다. 외부 공유용 문장과 내부 기록을 구분하고, 비밀번호나 인증정보는 저장하지 않습니다.

> 목양 기록의 완성은 긴 문장이 아니라, 다음 행동과 확인 날짜가 남아 있는 상태입니다.
